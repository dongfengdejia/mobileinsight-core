...
// const int EXPOSE_INTERNAL_LOGS=1;  //Yuanjie: 1 means expose all logs, 0
// means only public logs are exposed
...
const ValueName LogPacketTypeID_To_Name[] = {
    ...
    {LTE_NAS_ESM_Plain_OTA_Incoming_Message, // LTE ESM signaling message (merge
                                             // incoming/outgoing)
     "LTE_NAS_ESM_OTA_Incoming_Packet", true},
    {LTE_NAS_ESM_Plain_OTA_Outgoing_Message, // LTE ESM signaling message (merge
                                             // incoming/outgoing)
     "LTE_NAS_ESM_OTA_Outgoing_Packet", true},
    {LTE_NAS_EMM_Plain_OTA_Incoming_Message, // LTE EMM signaling message (merge
                                             // incoming/outgoing)
     "LTE_NAS_EMM_OTA_Incoming_Packet", true},
    {LTE_NAS_EMM_Plain_OTA_Outgoing_Message, // LTE EMM signaling message (merge
                                             // incoming/outgoing)
    ...
    {LTE_PHY_Connected_Mode_LTE_Intra_Freq_Meas_Results, // LTE infra-frequency
                                                         // measurements
                                                         // (connected mode)
    ...
    {LTE_PHY_Serving_Cell_Measurement_Result, // LTE serving cell measurement
                                              // result
     "LTE_PHY_Serv_Cell_Measurement", true},
    {LTE_PHY_Connected_Mode_Neighbor_Meas_Req_Resp, // LTE neighbor measurement
                                                    // request (connected mode)
    ...
    {GSM_RR_Cell_Reselection_Parameters, "GSM_RR_Cell_Reselection_Parameters",
     false},
    {GSM_RR_Cell_Information, "GSM_RR_Cell_Information", false},
    {GSM_RR_Cell_Reselection_Meas, "GSM_RR_Cell_Reselection_Meas", false},
    {GSM_RR_Signaling_Message, "GSM_RR_Signaling_Message", false},

    {GSM_DSDS_RR_Cell_Reselection_Parameters,
     "GSM_DSDS_RR_Cell_Reselection_Parameters", false},
    {GSM_DSDS_RR_Cell_Information, "GSM_DSDS_RR_Cell_Information", false},
    {GSM_DSDS_RR_Signaling_Message, "GSM_DSDS_RR_Signaling_Message", false},
