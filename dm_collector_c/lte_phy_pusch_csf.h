...
static int _decode_lte_phy_pusch_csf_payload(const char *b, int offset,
    ...
    case 102: {
        ...
        (void)_map_result_field_to_name(
            result, "PUSCH Reporting Mode", ValueNamePuschReportingMode,
            ARRAY_SIZE(ValueNamePuschReportingMode, ValueName), "(MI)Unknown");
        ...
        _replace_result_int(result, "WideBand CQI CW1", iWideBandCQICW1);
        _replace_result_int(result, "SubBand Size (k)", iSubBandSize);
        _replace_result_int(result, "Single WB PMI", iSingleWBPMI);
        _replace_result_int(result, "Single MB PMI", iSingleMBPMI);
    ...
    case 101: {
        ...
        (void)_map_result_field_to_name(
            result, "Csi Meas Set Index", ValueNameCsiMeasSetIndex,
            ARRAY_SIZE(ValueNameCsiMeasSetIndex, ValueName), "(MI)Unknown");
        _replace_result_int(result, "Number of Subbands", iNumSubbands);
        _replace_result_int(result, "WideBand CQI CW0", iWideBandCQICW0);
        _replace_result_int(result, "WideBand CQI CW1", iWideBandCQICW1);
        _replace_result_int(result, "SubBand Size (k)", iSubBandSize);
    ...
    case 42: {
        offset += _decode_by_fmt(LtePhyPuschCsf_Payload_v42,
                                 ARRAY_SIZE(LtePhyPuschCsf_Payload_v42, Fmt), b,
    ...
    case 23: {
        offset += _decode_by_fmt(LtePhyPuschCsf_Payload_v23,
                                 ARRAY_SIZE(LtePhyPuschCsf_Payload_v23, Fmt), b,
                                 offset, length, result);
        temp = _search_result_int(result, "Start System Sub-frame Number");
        int iSubFN = temp & 15;
        int iSysFN = (temp >> 4) & 1023;
    ...
    case 22: {
        offset += _decode_by_fmt(LtePhyPuschCsf_Payload_v22,
                                 ARRAY_SIZE(LtePhyPuschCsf_Payload_v22, Fmt), b,
                                 offset, length, result);
        temp = _search_result_int(result, "Start System Sub-frame Number");
        int iSubFN = temp & 15;
        int iSysFN = (temp >> 4) & 1023;
