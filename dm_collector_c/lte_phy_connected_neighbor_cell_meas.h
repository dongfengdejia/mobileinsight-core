...
static int _decode_lte_phy_connected_neighbor_cell_meas_payload(const char *b,
    ...
    case 1: {
        ...
        for (int i = 0; i < n_subpkts; i++) {
            ...
            offset +=
                _decode_by_fmt(LtePhyCncm_Subpacket_Header_v1,
            ...
            if (subpkt_id == 30) {
                ...
                offset += _decode_by_fmt(
                    ...
                    ARRAY_SIZE(LtePhyCncm_Subpacket_Payload_31v4, Fmt), b,
                ...
                for (int j = 0; j < num_cells; j++) {
                    ...
                    offset += _decode_by_fmt(
                        LtePhyCncm_Subpacket_31v4_cell,
                        ARRAY_SIZE(LtePhyCncm_Subpacket_31v4_cell, Fmt), b,
